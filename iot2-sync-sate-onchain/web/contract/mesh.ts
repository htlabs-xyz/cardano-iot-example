 ...
 * functions that enable higher-level contract managers (e.g. LockerContract)
 ...
 * - `lockerAddress`: Script address derived from the spending validator.
 * - `mintScript` / `lockerScript`: Fully parameterized Plutus V3 scripts.
 *
 * ## Notes:
...
export class MeshAdapter {
    ...
    /**
     * Wait for initialization to complete before accessing policyId/lockerAddress
     */
    ...
    private async initialize() {
        ...
        this.lockerScriptCbor = applyParamsToScript(
            this.lockerCompileCode,
            [pubKeyOwner],
        );
        this.lockerScript = {

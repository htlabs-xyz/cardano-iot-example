...
export default function TemperatureTable(props: TemperatureTableProps) {
    const { temperatureData = null, selectedRow, setSelectedRow, isLoading = false } = props;
    return (
        isLoading ? (
            <Card className="border rounded-lg bg-card h-[500px] overflow-hidden flex flex-col">
                <CardHeader>
            ...
            <div className="border rounded-lg bg-card h-[500px] overflow-hidden flex flex-col">

import { applyParamsToScript, deserializeAddress, IFetcher, MeshTxBuilder, MeshWallet, PlutusScript, resolveScriptHash, serializePlutusScript, UTxO } from "@meshsdk/core";
...
export class MeshAdapter {
    ...
    constructor({ meshWallet = null! }: { meshWallet?: MeshWallet }) {
        ...
        this.mintCompileCode = this.readValidator(blueprint as Plutus, "contract.status_management.mint");
        ...
        this.confirmStatusScript = {
         ...
         this.mintScriptCbor = applyParamsToScript(this.mintCompileCode, [this.pubKeyOwner]);

import { Injectable, PipeTransform, ArgumentMetadata, ValidationPipe, ValidationError } from '@nestjs/common';
import { WsException } from '@nestjs/websockets';

@Injectable()
export class SocketValidationPipe extends ValidationPipe implements PipeTransform {

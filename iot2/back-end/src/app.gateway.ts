...
export class AppGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  //   //const res = await this.appService.updateStatusDevice(payload);
  //   this.server.emit('onUpdatedLockStatus', res);
  // }

  // @ErrorEventName('onError')
  // @SubscribeMessage('newAuthorize')
  // async handleUpdateNewAuthorize(
  //   @MessageBody() payload: AuthorizeRequestModel,
  // ) {
  //   const res = await this.appService.requestAuthorize(payload);

            ...
            <AlertDialog open={dialogDelete} onOpenChange={setDialogDelete}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete your Collection and Metadata from
                            our servers.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                ...
                <div>
                    {openRenameInput ? (
                        ...
                        <>
                            <div className="flex items-center justify-between">
                                <Link
                                    href={routes.utilities.children.collection.redirect + `/${collection.id}`}

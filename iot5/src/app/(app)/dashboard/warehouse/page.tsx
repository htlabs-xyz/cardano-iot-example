                ...
                <div className="mt-2 flex gap-4">
                    ...
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingWarehouse ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {"Provide the name of the warehouse. Example: Da Lat Cold Storage"}
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {"Provide the capacity of the warehouse. Example: 1000Q"}
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}

        ...
        <>
            <AlertDialog open={open} onOpenChange={setOpen}>
                <AlertDialogContent className=" max-w-[40vw]">
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            You are initiating a burn of {hexToString(assetDetails.asset_name.replace(/^000643b0/, ""))}{" "}
                            for total quantity {quantityToBurn}
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            Please note: This action is permanent and will irreversibly remove your assets data on the
                            blockchain.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>

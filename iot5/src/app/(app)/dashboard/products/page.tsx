                ...
                <div className="mt-2 flex gap-4 ">
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingProduct ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {"Provide the name of the product. Example: Organic A2 Cheese"}
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the image URL of the product. Example: ipfs://QmZSLSNpbEBCLp9DhW8JB2Jmv1KwHSA"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>

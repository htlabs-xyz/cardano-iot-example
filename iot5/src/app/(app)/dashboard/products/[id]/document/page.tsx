                ...
                <div className="mt-2 flex gap-4 ">
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingDocument ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the type of the document (e.g., Certificate). Example: specification"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the URL of the document. Example: https://example.com/docs/cheese_spec.pdf"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input
                                                        placeholder="Enter blockchain hash (optional)"
                                                        {...field}
                                                        className="w-full"
                                                    />
                                                </FormControl>

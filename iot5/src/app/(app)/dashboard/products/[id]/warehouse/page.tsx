...
export default function WarehouseStoragePage() {
    ...
    const onSubmit = async (data: z.infer<typeof FormSchema>) => {
        try {
            ...
            toast({
                title: "Error",
                description: error + "An unexpected error occurred." + error,
                variant: "destructive",
            });
        }
    };
                ...
                <div className="mt-2 flex gap-4">
                    ...
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingStorage ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Select the warehouse for this record. Example: Phu Hoi Industrial Park, Lam Dong"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the entry time of the product. Example: 2025-04-10T10:18:00Z"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the exit time of the product (optional). Example: 2025-04-10T10:18:00Z"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the storage conditions (optional). Example: Temperature 4°C, Humidity 60%"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        ...
                                        <TableBody>
                                            {storageData?.data?.map((storage) => (
                                                <TableRow key={storage.id}>
                                                    ...
                                                    <TableCell className="border px-4 py-2">
                                                        {new Date(storage.entryTime).toLocaleDateString()}
                                                    </TableCell>
                                                    <TableCell className="border px-4 py-2">
                                                        {storage.exitTime
                                                            ? new Date(storage.exitTime).toLocaleDateString()
                                                            : "N/A"}
                                                    </TableCell>
                                                    <TableCell className="border px-4 py-2">

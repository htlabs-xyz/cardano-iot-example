...
} from "@/services/database/process";
                ...
                <div className="mt-2 flex gap-4 ">
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingProcess ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    {
                                                        "Provide the start time of the production process. Example: 2025-04-01T16:00:00Z"
                                                    }
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                    ...
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogContent>
                            ...
                            <p>
                                Are you sure you want to delete this production process? This action cannot be undone.
                            </p>
                            <DialogFooter>
                                        ...
                                        <TableBody>
                                            {processesData?.data?.map((process) => (
                                                <TableRow key={process.id}>
                                                    ...
                                                    <TableCell className="border px-4 py-2">
                                                        {process.location || "No location provided"}
                                                    </TableCell>

        ...
        <div className="py-8 px-10 m-auto flex flex-col max-md:px-0">
            <div className="rounded-xl p-6 bg-section shadow-md flex-wrap gap-3 space-y-5">
                <div className="mt-2 grid  gap-4 grid-cols-3 max-md:grid-cols-1">
                    <Link
                        href={`/dashboard/products/${id}/document`}
                        ...
                        <Card className="h-full">
                            ...
                            <div className="flex flex-col items-center justify-start gap-3 self-stretch px-4 py-2">
                                ...
                                <div className="font- self-stretch text-center text-sm text-secondary">
                                    Stores external documents related to products such as certificates or audits, with
                                    associated hash values.
                                </div>
                            </div>
                        </Card>
                    </Link>
                    ...
                    <Link
                        href={`/dashboard/products/${id}/warehouse`}
                        className="rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md"
                    >
                        <Card className="h-full">
                            <AspectRatio ratio={5 / 3} className="bg-muted">
                            ...
                            <div className="flex flex-col items-center justify-start gap-3 self-stretch px-4 py-2">
                                ...
                                <div className="font- self-stretch text-center text-sm text-secondary">
                                    Tracks product storage in a warehouse, including entry and exit timestamps and
                                    storage conditions
                                </div>
                            </div>
                        </Card>
                    ...
                    <Link
                        href={`/dashboard/products/${id}/process`}
                        className="rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md"
                    >
                        <Card className="h-full">
                            <AspectRatio ratio={5 / 3} className="bg-muted">
                            ...
                            <div className="flex flex-col items-center justify-start gap-3 self-stretch px-4 py-2">
                                ...
                                <div className="font- self-stretch text-center text-sm text-secondary">
                                    Describes the stages of a product manufacturing process, including start/end time
                                    and location
                                </div>
                            </div>
                        </Card>
                    ...
                    <Link
                        href={`/dashboard/products/${id}/certification`}
                        className="rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md"
                    >
                        <Card className="h-full">
                            <AspectRatio ratio={5 / 3} className="bg-muted">
                            ...
                            <div className="flex flex-col items-center justify-start gap-3 self-stretch px-4 py-2">
                                ...
                                <div className="font- self-stretch text-center text-sm text-secondary">
                                    Represents certificates issued to products, including issue/expiry dates and
                                    optional blockchain hashes.
                                </div>
                            </div>
                        </Card>
                    </Link>
                    ...
                    <Link
                        href={`/dashboard/products/${id}/feedback`}
                        className="rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md"
                    >
                        <Card className="h-full">
                            <AspectRatio ratio={5 / 3} className="bg-muted">

...
export default function MaterialPage() {
    ...
    const handleEdit = (material: Material) => {
        ...
        form.setValue(
            "harvestDate",
            material.harvestDate ? new Date(material.harvestDate).toISOString().split("T")[0] : "",
        );
    };
                ...
                <div className="mt-2 flex gap-4">
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingMaterial ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the name of the material. Example: Fresh A2 Cow Milk
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the quantity of the material. Example: 500.0
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the harvest date of the material (optional). Example:
                                                ...
                                                <TableRow key={material.id}>
                                                    ...
                                                    <TableCell className="border px-4 py-2">
                                                        {material.harvestDate
                                                            ? new Date(material.harvestDate).toLocaleDateString()
                                                            : "N/A"}
                                                    </TableCell>

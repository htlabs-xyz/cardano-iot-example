                ...
                <div className="mt-2 flex gap-4 ">
                    <div className="flex-[2] rounded-lg shadow-none transition-shadow duration-300 hover:shadow-md">
                        <Card className="h-full p-4">
                            <Form {...form}>
                                <form
                                    onSubmit={form.handleSubmit(editingSupplier ? handleSave : onSubmit)}
                                    className="w-full"
                                >
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the name of the supplier. Example: Cau Dat Dairy Farm
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the location of the supplier. Example: Da Lat
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the GPS coordinates of the supplier. Example: 11.9386,
                                                    108.4558
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Provide the contact information of the supplier. Example: Phone
                                                    Number 0123456789
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                                        ...
                                                        <HoverCard>
                                                            ...
                                                            <HoverCardContent className="w-40 p-2 flex flex-col gap-2 shadow-lg border rounded-md">
                                                                <Button
                                                                    ...
                                                                    onClick={() =>
                                                                        router.push(
                                                                            `/dashboard/suppliers/${supplier.id}/materials`,
                                                                        )
                                                                    }
                                                                >
                                                                    <span>Material</span>

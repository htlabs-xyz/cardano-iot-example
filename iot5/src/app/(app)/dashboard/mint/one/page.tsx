...
import TransportationStep from "../_components/mint-step/transportation";
                ...
                <div className="space-y-4">
                    {mintOneStepper.switch({
                        ...
                        transportation: () => (
                            <TransportationStep
                                stepper={mintOneStepper}
                                setTransportationToMint={setTransportationToMint}
                                transportationToMint={transportationToMint}
                            />
                        ),
                        preview: () => (
                            <PreviewStep

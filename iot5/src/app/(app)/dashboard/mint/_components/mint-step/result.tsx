                ...
                <div key={index} className="h-full py-8 px-10 m-auto flex flex-col">
                    <div className="flex flex-col items-center justify-center text-white">
                        ...
                        <p className="mb-4 max-w-md text-center text-sm text-gray-300">
                            Check your Nft in your Wallet. If it’s not visible, please wait a moment for the transaction
                            to complete.
                        </p>
    ...
    return (
        <div className="h-full py-8 px-10 m-auto flex flex-col">
            <div className="flex flex-col items-center justify-center text-white">
                ...
                <p className="mb-4 max-w-md text-center text-sm text-gray-300">
                    Check your Nft in your Wallet. If it’s not visible, please wait a moment for the transaction to
                    complete.
                </p>
                <div className="flex flex-row items-center justify-center space-x-4">
                    <Link

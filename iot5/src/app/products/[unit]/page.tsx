...
export default function ProductsPage() {
    ...
    const { asset_name, policy_id, metadata, fingerprint, quantity } =
        assetData?.data || ({} as AssetDetailsWithTransactionHistory);
                                    ...
                                    <CardContent className="p-6 space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2">
                                                <h1 className="text-2xl font-bold overflow-hidden whitespace-nowrap">
                                                    {assetNameString}
                                                </h1>
                                        ...
                                        <div className="space-y-2 ">
                                            <div className="flex items-center justify-between p-2 bg-gray-800 rounded-lg">
                                                <span className="text-sm text-gray-400 text-ellipsis overflow-hidden whitespace-nowrap">
                                                    Policy ID: {policy_id}
                                                </span>
                                                <Copy content={policy_id} className="h-8 w-8" />
                                            </div>
                                            <div className="flex items-center justify-between p-2 bg-gray-800 rounded-lg">
                                                <span className="text-sm text-gray-400 overflow-hidden whitespace-nowrap">
                                            ...
                                            <div className="grid grid-cols-4 gap-y-5 gap-x-2">
                                                {metadataToUpdate &&
                                                    Object.entries(metadataToUpdate).map(([name, value], index) => (
                                                        <Property key={index} name={name} value={value} />
                                                    ))}
                                            </div>
                                        </div>
                                    </Card>

...
const banners = [
    { image: appImage.certification },
    { image: appImage.collection },
    { image: appImage.about },
    { image: appImage.storegae },
];
                    ...
                    {!isLoading ? (
                                        ...
                                        <Card className="w-full rounded-lg border ">
                                            ...
                                            <CardContent className="flex flex-col items-center gap-6 pb-8">
                                                <p className="text-gray-400 text-center">
                                                    We couldn't find any NFTs that match your search criteria.
                                                </p>
                                            </CardContent>
                                        </Card>
                                    </div>
                        ...
                        <div className="h-[60vh] w-full space-y-4 rounded-lg py-4">
                            <Card className="w-full rounded-lg border">
                                ...
                                <CardContent className="flex flex-col items-center gap-6 pb-8">
                                    <p className="text-gray-400 text-center">
                                        To get started you'll need your prepared assets, we'll help guide you along your
                                        way.
                                    </p>
                                </CardContent>
                            </Card>
                    ...
                    <div className="flex w-full gap-7 max-sm:flex-col">
                        ...
                        <div className="z-10 flex w-[40%] flex-col items-start gap-[15px] max-md:gap-3 max-sm:w-full">
                            ...
                            <span className={"text-left leading-[1.8] max-md:text-base"}>
                                Supply Chain Traceability Generator: Simplifying Asset Management on Blockchain,
                                Open-Source Transparency for Supply Chains, Simplify Blockchain-Based Supply Chain
                                Tracking. Supply Chain Traceability Generator: Simplifying Asset Management on
                                Blockchain, Open-Source Transparency for Supply Chains, Simplify Blockchain-Based Supply
                                Chain Tracking. Supply Chain Traceability Generator: Simplifying
                            </span>

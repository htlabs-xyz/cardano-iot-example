...
export const Images = {
    ...
    certification: (props: LucideProps) => (
        <Image src={appImage.certification} className={props.className} alt="Logo" />
    ),
    ...
    marketplace: (props: LucideProps) => (
        <Image src={appImage.marketplace} className={props.className} alt="metadata" />
    ),
    collection: (props: LucideProps) => (
        <Image src={appImage.collection} className={props.className} alt="Collection" />
    ),
    fastCollection: (props: LucideProps) => (
        <Image src={appImage.fastCollection} className={props.className} alt="Fast Collection" />
    ),
    ...
    startFromScratch: (props: LucideProps) => (
        <Image src={appImage.startFromCratch} className={props.className} alt="Start from Scratch" />
    ),
};
